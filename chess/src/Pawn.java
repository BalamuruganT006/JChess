...
public class Pawn extends Piece {
    ...
    public Pawn(COLOUR colour, Coordinate OGcoord) {
        ...
        if (getColour() == COLOUR.B)
            icon = new ImageIcon(getClass().getResource("/images/BPawn.png"));
        else if (getColour() == COLOUR.W)
            icon = new ImageIcon(getClass().getResource("/images/WPawn.png"));
    }
    ...
    public void GUIPromotionQuery (Coordinate promotionSquare) {
        ...
        if (this.getColour() == COLOUR.B) {
            queenOption = new JButton(new ImageIcon(getClass().getResource("/images/BQueen.png")));
            rookOption = new JButton(new ImageIcon(getClass().getResource("/images/BRook.png")));
            bishopOption = new JButton(new ImageIcon(getClass().getResource("/images/BBishop.png")));
            knightOption = new JButton(new ImageIcon(getClass().getResource("/images/BKnight.png")));
            promotedPiece = new Queen(COLOUR.B,promotionSquare);
            icon = new ImageIcon(getClass().getResource("/images/BPawn.png"));
        }
        else {
            queenOption = new JButton(new ImageIcon(getClass().getResource("/images/WQueen.png")));
            rookOption = new JButton(new ImageIcon(getClass().getResource("/images/WRook.png")));
            bishopOption = new JButton(new ImageIcon(getClass().getResource("/images/WBishop.png")));
            knightOption = new JButton(new ImageIcon(getClass().getResource("/images/WKnight.png")));
