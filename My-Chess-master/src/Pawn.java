...
public class Pawn extends Piece {
    ...
    public Pawn(COLOUR colour, Coordinate OGcoord) {
        ...
        String imagePath = System.getProperty("user.dir") + "/My-Chess-master/src/images/";
        if (getColour() == COLOUR.B)
            icon = new ImageIcon(imagePath + "BPawn.png");
        else if (getColour() == COLOUR.W)
            icon = new ImageIcon(imagePath + "WPawn.png");
    }
    ...
    public void GUIPromotionQuery (Coordinate promotionSquare) {
        ...
        if (this.getColour() == COLOUR.B) {
            queenOption = new JButton(new ImageIcon(imagePath + "BQueen.png"));
            rookOption = new JButton(new ImageIcon(imagePath + "BRook.png"));
            bishopOption = new JButton(new ImageIcon(imagePath + "BBishop.png"));
            knightOption = new JButton(new ImageIcon(imagePath + "BKnight.png"));
            promotedPiece = new Queen(COLOUR.B,promotionSquare);
            icon = new ImageIcon(imagePath + "BPawn.png");
        }
        else {
            queenOption = new JButton(new ImageIcon(imagePath + "WQueen.png"));
            rookOption = new JButton(new ImageIcon(imagePath + "WRook.png"));
            bishopOption = new JButton(new ImageIcon(imagePath + "WBishop.png"));
            knightOption = new JButton(new ImageIcon(imagePath + "WKnight.png"));
